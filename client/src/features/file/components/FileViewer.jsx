...
import { getGoogleDriveFile } from "@/features/Explorer/explorerThunk";
    ...
    return (
      <div className="text-center p-12 bg-slate-900 rounded-2xl border border-slate-800">
        ...
        <Button
          ...
          variant="outline"
          className="text-slate-900 border-white/10 hover:bg-slate-100"
        >
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col bg-slate-950/95 backdrop-blur-md animate-in fade-in duration-300 text-slate-200">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          {isImage && (
            <div className="hidden md:flex items-center bg-white/5 rounded-lg p-1 mr-2 border border-white/5">
              ...
              <span className="text-xs font-mono w-10 text-center text-slate-400">
                {zoom}%
              </span>
              <Button
                variant="ghost"
          ...
          <div className="flex items-center gap-1">
            ...
            <Button
              ...
              onClick={handlePrint}
              title="Print"
              className="hidden sm:inline-flex text-slate-400 hover:text-white hover:bg-white/10"
            >
              <Printer size={18} />
            </Button>
      ...
      <div className="flex-1 flex overflow-hidden relative">
        {/* Canvas */}
        <div
          className="flex-1 flex items-center justify-center p-4 sm:p-8 overflow-auto bg-transparent"
...
const InfoRow = ({ label, value, fontMono }) => (
  <div className="space-y-1">
    ...
    <div
      className={cn(
        "text-sm text-slate-300 break-words",
        fontMono && "font-mono text-xs bg-white/5 p-2 rounded",
      )}
    >
      {value}
    </div>
